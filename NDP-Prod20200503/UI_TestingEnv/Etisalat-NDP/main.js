...
var AddEditCampaignComponent = /** @class */ (function () {
    ...
    AddEditCampaignComponent.prototype.showSmsScriptWarning = function () {
    ...
    AddEditCampaignComponent.prototype.ngOnInit = function () {
        ...
        this.campaignForm = this.formBuilder.group({
            ...
            paceRate: [1],
            groupId: [null],
            notificationText: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_6__["Validators"].required, this.nonEmptyValidator(), this.charsetValidator]],
        ...
        this.campaignForm.controls.notificationText.valueChanges.subscribe(function (val) {
            if (val) {
                ...
                var arabic = /[\u0600-\u06FF]/;
                _this.smsMaxCharCount = arabic.test(val) ? 67 : 140;
            }
            else {
    ...
    AddEditCampaignComponent.prototype.editCampaign = function (campaign) {
        ...
        this.campaignForm.patchValue({
            ...
            status: (this.user.needsApproval ? src_app_shared_static_defines__WEBPACK_IMPORTED_MODULE_9__["Defines"].CAMPAIGN_STATUS.PENDING : (this.mode === 2) ? src_app_shared_static_defines__WEBPACK_IMPORTED_MODULE_9__["Defines"].CAMPAIGN_STATUS.APPROVED : campaign.status),
    ...
    AddEditCampaignComponent.prototype.charsetValidator = function (control) {
        // const arabic = /[\u0600-\u06FF]/;
        // const english = /[\u0020-\u007E]/;
        var value = control.value;
        if (value) {
            var searchResult = value.search('([^\u0600-\u06FF\u0020-\u007E])');
            if (searchResult != -1) {
...
var TestSmsComponent = /** @class */ (function () {
    ...
    TestSmsComponent.prototype.ngOnInit = function () {
        ...
        this.smsTestForm = this.formBuilder.group({
            dialWithParameters: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('[+]?[0][1][1|0|2|5][0-9]{8}([,][A-z0-9]+[=][\u0001-\u002B\u002D-\u06FF]+)*')]]
        });
    };
...
var environment = {
    production: true,
    backendUrl: "http://10.195.5.65:9089/ndpadmin",
    backendContext: "/ndpadmin",
    secureApiUrl: "/b2bApi",
    nonSecureApiUrl: "",
    campaignAdminId: 1, campaignManagerId: 2, campaignViewerId: 3
};
