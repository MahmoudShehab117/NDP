...
public class Properties {
    ...
    private Boolean nbaTibcoIntegrationIsEnabled;
    ...
    public Boolean getNbaTibcoIntegrationIsEnabled() {
        return nbaTibcoIntegrationIsEnabled;
    }

    public void setNbaTibcoIntegrationIsEnabled(Boolean nbaTibcoIntegrationIsEnabled) {
        this.nbaTibcoIntegrationIsEnabled = nbaTibcoIntegrationIsEnabled;
    }
