...
public class NBAProxy {
    ...
    public List<GiftModel> getAllGifts(GetAllGiftsRequest getAllGiftsRequest) throws GatewayException {
        ...
        try {
            ...
            Boolean tibcoIsEnable = properties.getNbaTibcoIntegrationIsEnabled();
            ...
            throw new GatewayException(ErrorCodes.ERROR.INTERNAL_SERVICE_UNREACHABLE, "nba-service[" + properties.getNbaServiceUrls() + "]");
        }
        return model;
    }
    ...
    public void acceptGift(AcceptGiftRequest acceptGiftRequest) throws GatewayException {
        ...
        try {
            ...
            CCATLogger.DEBUG_LOGGER.info("Error while retrieving AccumulatorModel ");
            CCATLogger.ERROR_LOGGER.error("Error while retrieving AccumulatorModel ", ex);
            throw new GatewayException(ErrorCodes.ERROR.INTERNAL_SERVICE_UNREACHABLE, "NBA-service[" + properties.getAirServiceUrls() + "]");
        }
    }
