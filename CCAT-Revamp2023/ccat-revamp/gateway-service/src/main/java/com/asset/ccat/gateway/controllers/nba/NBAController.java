...
public class NBAController {
    ...
    public BaseResponse<List<GiftModel>> getGifts(HttpServletRequest req,
                                                  @RequestBody GetAllGiftsRequest getAllGiftsRequest) throws AuthenticationException, Exception {
        HashMap<String, Object> tokendata = jwtTokenUtil.extractDataFromToken(getAllGiftsRequest.getToken());
    ...
    public BaseResponse acceptGifts(HttpServletRequest req,
        ...
        HashMap<String, Object> tokendata = jwtTokenUtil.extractDataFromToken(acceptGiftRequest.getToken());
    ...
    public BaseResponse sendSms(HttpServletRequest req,
        ...
        HashMap<String, Object> tokendata = jwtTokenUtil.extractDataFromToken(sendGiftRequest.getToken());
        String username = tokendata.get(Defines.SecurityKeywords.USERNAME).toString();
    ...
    public BaseResponse rejectGift(HttpServletRequest req,
        ...
        HashMap<String, Object> tokendata = jwtTokenUtil.extractDataFromToken(rejectGiftRequest.getToken());
        String sessionId = tokendata.get(Defines.SecurityKeywords.SESSION_ID).toString();
        String username = tokendata.get(Defines.SecurityKeywords.USERNAME).toString();
